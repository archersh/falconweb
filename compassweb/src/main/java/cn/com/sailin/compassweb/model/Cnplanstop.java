...
public class Cnplanstop {
	...
	public void applyJson(String applyData) {
		...
		stopremark = obj.getString("stopremark");
	...
	public String toXml() {
		try {
			...
			Element rnstopremark = doc.createElement("stopremark");
			CDATASection rnstopremarkval = doc.createCDATASection(stopremark);
			rnstopremark.appendChild(rnstopremarkval);
			root.appendChild(rnstopremark);
