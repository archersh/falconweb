...
public class Cnplanorderrefund {
	...
	public void applyJson(String applyData) {
		...
		refundaccount = obj.getString("refundaccount");
		staff = obj.getString("staff");
		...
		l.add("rvn=" + rvn);
		l.add("cycode=" + cycode);
		l.add("refundaccount=" + refundaccount);
		l.add("staff=" + staff);
	...
	public String toXml() {
		try {
			...
			Element rnrefundaccount=doc.createElement("refundaccount");
			CDATASection rnrefundaccountval=doc.createCDATASection(refundaccount);
			rnrefundaccount.appendChild(rnrefundaccountval);
			root.appendChild(rnrefundaccount);
			
			Element rnstaff=doc.createElement("staff");
			CDATASection rnstaffval=doc.createCDATASection(staff);
			rnstaff.appendChild(rnstaffval);
			root.appendChild(rnstaff);
